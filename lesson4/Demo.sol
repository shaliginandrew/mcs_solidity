...
1)содержит две структуры Платеж(поля- сумма платежа, время платежа, адрес плательщика, сообщение)и Баланс на счете(поля - общее количество платежей и мапа ключ - номер платежа, значение платеж
2)функция для приема платежей, в которую передаем временное сообщение. При поступлении платежа - сохраняем о нем информацию в мапу и сохраняем в блокчейн. 
...
3)получаем платежи из мапы баланс
