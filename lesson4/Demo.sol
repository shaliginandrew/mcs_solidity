...
4)Объявить и инициализировать перечисление Статус со значениями Paid, Delivered, Received
Объявить переменную текущий статус с типом перечисления
Создать функции оплачено, выполняется выполнено и проинициализировть в них переменную текущий статус
5)Объявить массив 3x2
Объявить функцию, в которой проинициализировать этот массив
6)Объявить динамический массив
Объявить переменную длины массива
Объявить функцию, которая добавляет в массив два числа и вычиляет его длину
7) Объявить функцию sampleMemory() с типом возвращаемого значения временный диначмический массив в
которой создается динамический массив из 10 элекментов и сохраняется во временный динамический массив 
Присваиваем нулевому элементу временного массива цифру и возвращаем врменный массив
8) Проинициализировать фиксированный байтовый массив строкой
Проиницализировть динамический байтовй массив строкой 
Объявить функцию которая возвращает первый байт динамического байтового массива
*/
contract Demo {
